...
import (
	master "github.com/akubi0w1/sge-tech-book-vol3-sample/pkg/pb/master"
...
var file_service_master_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x3e, 0x5a,
	0x3c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x6b, 0x75, 0x62,
	0x69, 0x30, 0x77, 0x31, 0x2f, 0x73, 0x67, 0x65, 0x2d, 0x74, 0x65, 0x63, 0x68, 0x2d, 0x62, 0x6f,
	0x6f, 0x6b, 0x2d, 0x76, 0x6f, 0x6c, 0x33, 0x2d, 0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2f, 0x70,
	0x6b, 0x67, 0x2f, 0x70, 0x62, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x62, 0x06, 0x70,
...
func file_service_master_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_service_master_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Empty); i {
			case 0:
				return &v.state
			case 1:
		...
		file_service_master_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_service_master_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_service_master_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
